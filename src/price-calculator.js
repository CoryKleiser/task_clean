...
/*** Changes
 ES5 => ES6+
 Updated to use closures instead of making function global. (thinking of making the global function that sets everything up a class or object but would have to change the index.html)
